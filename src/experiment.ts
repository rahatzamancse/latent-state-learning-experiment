...
import { readFile, shuffleIndices } from "./utils";
...
import DragndropPlugin from "./plugin-dragndrop";
...
<p>Press any key to go next.</p>`
  ...
  const stimulus = await Promise.all([
    ...
    "assets/images/drone_frame.png",
    features.map(f => `assets/images/features/${f}.png`)
  )));

  const BASKETS = shuffleIndices(4).map(i => [
    {
      color: "blue",
      image: "assets/images/baskets/basket-blue.png",
      name: "Emerald Vault",
    },
    {
      color: "green",
      image: "assets/images/baskets/basket-green.png",
      name: "Azure Haven",
    },
    {
      color: "red",
      image: "assets/images/baskets/basket-red.png",
      name: "Crimson Nook",
    },
    {
      color: "yellow",
      image: "assets/images/baskets/basket-yellow.png",
  ...
  const firstReward = {
    type: HtmlKeyboardResponsePlugin,
    stimulus: () => getOutcome() ? `<img src="assets/images/reward/diamond.png" width="500px" /><p>Well done! You have earned a magical reward!</p>` : `<img src="assets/images/reward/nodiamond.png" width="500px" /><p>Oops! You have not earned a magical reward this time. Please try again.</p>`,
  };
  const firstLoop = {
